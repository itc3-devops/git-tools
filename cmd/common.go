...
func GitCreateNewRepo(name string, private bool) {
	ctx := context.Background()
	ts := oauth2.StaticTokenSource(
		&oauth2.Token{AccessToken: viper.GetString("Repository.Github.Token")},
	)
...
func GitGetRepoInformation(repoOwner string, repoName string) {
...
func GitGetRepoReadmeInfo(repoOwner string, repoName string) {
...
func GitGetRepoLastCommitInfo(repoOwner string, repoName string) {
...
func GitGetFileContents(repoOwner string, repoName string, fileName string) {
...
func GitPutEncryptedFileContents(repoOwner string, repoName string, filePathName string, data string, updateMessage string) error {
	var encData string
	var contents []byte
...
func GitUpdateEncryptedFileContents(repoOwner string, repoName string, filePathName string, data string, updateMessage string) error {
	var encData string
	var contents []byte
	...
	message := updateMessage
	branch := "master"
	sha, _ := getSha(client, repoOwner, repoName, filePathName)
...
func GitGetEncryptedFileContents(repoOwner string, repoName string, fileName string) {
	var encData string
...
func GitExistEncryptedFile(repoOwner string, repoName string, filePathName string) bool {
